...
public class Base_Page {
    ...
    public String getCssAtribute(String locator){
        return getDriver().findElement(By.cssSelector(locator)).getAttribute("id");
    }
    ...
    public void  changeIframeID(int indice){
        try{
            System.out.println(getDriver().switchTo().frame(indice).findElement(By.cssSelector(".ima-sdk-frame .videoAdUi")).getAttribute("class"));
    ...
    public void visitUrl(String nota){
        getDriver().get(nota);
    }

    public void validatePageNotFound(String page){
        if(getText(".text-6xl").equals("404")){
            System.out.println("Pagina no encontrada : " + page );
        }
    }
